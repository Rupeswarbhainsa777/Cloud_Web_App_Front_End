             ...
             <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                 ...
                 <div className="relative  ">
                     ...
                     <div className="aspect-w-16 rounded-lg shadow-xl overflow-hidden ">
                          ...
                          <img src={assests.dashboard} alt="cloudeshare dashboard"   className="w-full h-full  object-cover "  />
                     ...
                     <div className="mt-8 text-center">
                         <p className="mt-4 text-base text-gray-500 ">
                             All yours files are encrypted and stored securely with enterprise-grade security protocols.
                         </p>
                     </div>
